    ...
    <div>
      <div className="mb-8 flex flex-col justify-between gap-4 sm:flex-row sm:items-end">
        <div>
          ...
          <h2 className="font-display text-3xl font-semibold tracking-normal sm:text-4xl">
      ...
      <div className="grid gap-5 lg:grid-cols-3">
        {showcasedProjects.map((project) => (
          <article key={project.slug} className="card-glass rounded-lg p-5">
            <div className="mb-4">
              <h3 className="font-display text-xl font-semibold tracking-normal">{project.name}</h3>
