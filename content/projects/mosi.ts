export const mosiContent = {
  ...
  dataSources: `Derivation cohort: 3,097 patients who underwent primary bariatric surgery at Mayo Clinic, Rochester, MN (2010-2022). Prospective validation cohort: multi-institutional, external, currently enrolling. Data include: preoperative BMI, HbA1c, blood pressure, comorbidity index, procedure type, and 12-month postoperative total weight loss (TWL%).`,
